#ifndef _ROS_amp_msgs_ConeList_h
#define _ROS_amp_msgs_ConeList_h
...
namespace amp_msgs
{
  ...
  class ConeList : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "amp_msgs/ConeList"; };
    virtual const char * getMD5() override { return "462ac0ba687f22c2e73c0ec0413e0202"; };
